...
(function() {
            ...
            domReady: function() {
                function a() {
                    try {
                        ...
                        d()) : document.attachEvent && "complete" === document.readyState && (document.detachEvent("onreadystatechange", a), 
                        d());
                    } catch (e) {}
                }
                function d() {
                ...
                return function(n, h, i) {
                    ...
                    if (m) {
                        ...
                        if (s.length) for (var s = s.slice(0), x, q = 0; q < s.length; q++) {
                            if (m.errorProof) try {
                                x = s[q].call(this, i, h, d, b);
                            } catch (o) {} else x = s[q].call(this, i, h, d, b);
    ...
    "unloaded" == CKEDITOR.status && function() {
        ...
        (function() {
            CKEDITOR.domReady(function() {
                var a = CKEDITOR.loadFullCore, c = CKEDITOR.loadFullCoreTimeout;
                if (a) {
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            createClass: function(a) {
                ...
                if (e) {
                    d.prototype = this.prototypedCopy(e.prototype);
            ...
            convertRgbToHex: function(a) {
                return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function(a, d, e, b) {
                    a = [ d, e, b ];
            ...
            enableHtml5Elements: function(a, d) {
                for (var e = [ "abbr", "article", "aside", "audio", "bdi", "canvas", "data", "datalist", "details", "figcaption", "figure", "footer", "header", "hgroup", "mark", "meter", "nav", "output", "progress", "section", "summary", "time", "video" ], b = e.length, c; b--; ) {
    ...
    CKEDITOR.dom.domObject.prototype = function() {
        ...
        return {
            ...
            on: function(c) {
                ...
                if (!b[c]) {
                    b = b[c] = a(this, c);
                    this.$.addEventListener ? this.$.addEventListener(c, b, !!CKEDITOR.event.useCapture) : this.$.attachEvent && this.$.attachEvent("on" + c, b);
                }
            ...
            removeAllListeners: function() {
                ...
                for (b in a) {
                    var f = a[b];
                    this.$.detachEvent ? this.$.detachEvent("on" + b, f) : this.$.removeEventListener && this.$.removeEventListener(b, f, false);
                    delete a[b];
                }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getNextSourceNode: function(a, c, b) {
            ...
            return !a || b && b(a) === false ? null : c && c != a.type ? a.getNextSourceNode(false, c, b) : a;
        },
        ...
        getPosition: function(a) {
            ...
            if (this.type == CKEDITOR.NODE_ELEMENT && a.type == CKEDITOR.NODE_ELEMENT) {
                if (c.contains) {
                    ...
                    if (b.contains(c)) return CKEDITOR.POSITION_IS_CONTAINED + CKEDITOR.POSITION_FOLLOWING;
                }
            ...
            return c.length < a.length ? CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_PRECEDING : CKEDITOR.POSITION_IS_CONTAINED + CKEDITOR.POSITION_FOLLOWING;
        },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        getByAddress: function(a, c) {
            for (var b = this.$.documentElement, f = 0; b && f < a.length; f++) {
                var d = a[f];
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function() {
                ...
                for (var e = 0; e < arguments.length; e++) if (arguments[e] == a) return true;
                return false;
            },
            ...
            isEmptyInlineRemoveable: function() {
                ...
                for (var a = this.getChildren(), e = 0, b = a.count(); e < b; e++) {
                    var c = a.getItem(e);
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks) ? function() {
                ...
                var a = this.$.attributes, e = a.length, b = {
                    "data-cke-expando": 1,
                    _moz_dirty: 1
                };
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var m = this.$.getBoundingClientRect(), p = f.$.documentElement, s = p.clientTop || h.$.clientTop || 0, x = p.clientLeft || h.$.clientLeft || 0, q = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function() {
        function a(a, b) {
            ...
            if (this.current) d = this.current[v](false, j, k); else {
                if (a) d.type == CKEDITOR.NODE_ELEMENT && (d = m > 0 ? d.getChild(m - 1) : k(d, true) === false ? null : d.getPreviousSourceNode(true, j, k)); else {
                    d = e;
    ...
    (function() {
        ...
        var f = function(a) {
            ...
            if (f.type == CKEDITOR.NODE_TEXT) f = f.split(g); else if (f.getChildCount() > 0) if (g >= f.getChildCount()) {
            ...
            for (d = j; d < g.length; d++) {
                ...
                if (!u[d] || i.$.parentNode != u[d].$.parentNode) for (i = i.getPrevious(); i; ) {
                    ...
                    if (b == 2) r.$.insertBefore(i.$.cloneNode(true), r.$.firstChild); else {
                        i.remove();
                        b == 1 && r.$.insertBefore(i.$, r.$.firstChild);
                    }
                    i = F;
                }
                r && (r = n);
        ...
        CKEDITOR.dom.range.prototype = {
                ...
                switch (a) {
                  ...
                  case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    if (r.type == CKEDITOR.NODE_TEXT) {
                        if (n) {
                            r = !CKEDITOR.tools.trim(r.substring(0, n)).length && r;
                            g = !!r;
                        }
                        ...
                        for (;j; ) {
                            ...
                            if (j.type == CKEDITOR.NODE_COMMENT) j = j.getPrevious(); else {
                                if (j.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    c.test(h) && (j = null);
                                    r = /[\s\ufeff]$/.test(h);
                                } else if ((j.$.offsetWidth > 0 || b && j.is("br")) && !j.data("cke-bookmark")) if (g && CKEDITOR.dtd.$removeEmpty[j.getName()]) {
                                    h = j.getText();
                    ...
                    v = g = false;
                    var L = function(a, b) {
                        var d = new CKEDITOR.dom.range(u);
                        d.setStart(a, b);
                  ...
                  case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var J, w, z = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                        br: 1
                    } : null), t = null, E = function(a) {
            ...
            shrink: function(a, b, d) {
                if (!this.collapsed) {
                    ...
                    c.guard = function(b, c) {
                        if (j(b)) return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || c && b.equals(v) || d === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return false;
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) {
                    for (var d = this.createBookmark(), c = this[b ? "endPath" : "startPath"](), e = c.block || c.blockLimit, f; e && !e.equals(c.root) && !e.getFirst(a(e)); ) {
                        f = e.getParent();
    ...
    (function() {
        ...
        var d = /^[\r\n\t ]+$/, e = CKEDITOR.dom.walker.bookmark(false, true), g = CKEDITOR.dom.walker.whitespaces(true), n = function(a) {
            return e(a) && g(a);
        };
        a.prototype = {
                ...
                for (this._.nextNode = null; o; ) {
                    ...
                    if (k) o.type == CKEDITOR.NODE_TEXT && d.test(o.getText()) && (k = 0); else {
                        ...
                        if (CKEDITOR.dtd.$block[j] && o.getAttribute("contenteditable") == "false") {
                            ...
                            f(this, a, b);
                            break;
                        } else if (o.isBlockBoundary(this.forceBrBreak && !A && {
                            br: 1
                        })) {
                            if (j == "br") k = 1; else if (!g && !o.getChildCount() && j != "hr") {
                                b = o;
                                p = o.equals(q);
                                break;
                            }
                    ...
                    if (g && !u) for (;!o.getNext(n) && !p; ) {
                        j = o.getParent();
                        if (j.isBlockBoundary(this.forceBrBreak && !A && {
                            br: 1
                        })) {
                            u = 1;
                            k = 0;
    ...
    (function() {
        function a(a, b, d, c, e) {
            ...
            for (f in b) {
                o = b[f];
                o = typeof o == "boolean" ? {} : typeof o == "function" ? {
                    match: o
                } : L(o);
            ...
            if (!a.match || a.match(d)) if (e || n(a, d)) {
                ...
                if (!c.allClasses) {
                    ...
                    if (a) if (a === true) a = true; else {
                        for (var f = 0, o = d.length, j; f < o; ++f) {
                            j = d[f];
                            e[j] || (e[j] = a(j));
                        }
                        a = false;
        ...
        function s(a) {
            var b = a.styleBackup = a.attributes.style, d = a.classBackup = a.attributes["class"];
            ...
            if (e.doFilter) {
                a: {
                    ...
                    if (!a && !k) a = null; else {
                        ...
                        if (a) {
                            q = 0;
                            for (w = a.length; q < w; ++q) c(a[q], b, y, r);
                        }
                        if (k) {
                            q = 0;
        ...
        var F = CKEDITOR.dtd, D = 1, L = CKEDITOR.tools.copy, J = CKEDITOR.tools.trim, w = "cke-test", z = [ "", "p", "br", "div" ];
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, d, c) {
                ...
                var f, o;
                if (typeof b == "string") b = m(b); else if (b instanceof CKEDITOR.style) {
                    ...
                    for (f = 0; f < b.length; ++f) o = this.allow(b[f], d, c);
                    return o;
                }
            ...
            applyTo: function(a, b, d, c) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || !(a.name == "span" && ~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))) {
                            k = x(e, a, f, g);
                            if (k & D) l = true; else if (k & 2) return false;
                        }
                ...
                f.length && (l = true);
                for (var v, a = [], c = z[c || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; d = f.pop(); ) d.type == CKEDITOR.NODE_ELEMENT ? j(d, c, a) : d.remove();
                for (;v = a.pop(); ) {
                    d = v.el;
            ...
            addContentForms: function(a) {
                if (!this.disabled && a) {
                    ...
                    if (e) {
                        for (b = 0; b < a.length; ++b) c.push(r(a[b], e));
            ...
            check: function(a, b, d) {
                ...
                if (typeof a == "string") {
                    ...
                    if (e) c.attributes.style = CKEDITOR.tools.writeCssText(c.styles);
                    e = c;
                } else {
                    c = a.getDefinition();
                    e = c.styles;
                ...
                x(this, j, k, {
                    ...
                    doTransform: b !== false,
                    skipRequired: !d,
                    skipFinalValidation: !d
                });
                b = k.length > 0 ? false : CKEDITOR.tools.objectCompare(e.attributes, j.attributes, true) ? true : false;
    ...
    (function() {
        ...
        function m(a) {
            ...
            CKEDITOR.plugins.load(d.split(","), function(d) {
                ...
                for (var k in d) {
                    ...
                    if (g && !a.lang[k]) {
                        g.split && (g = g.split(","));
                        if (CKEDITOR.tools.indexOf(g, a.langCode) >= 0) h = a.langCode; else {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            setKeystroke: function() {
                for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [ [].slice.call(arguments, 0) ], d, c, e = b.length; e--; ) {
                    d = b[e];
                    c = 0;
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            ...
            insertAfter: function(a) {
                var c = a.parent.children, b = CKEDITOR.tools.indexOf(c, a), f = a.next;
                c.splice(b + 1, 0, this);
                this.next = a.next;
                this.previous = a;
                a.next = this;
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(e, g, n) {
            function h(a) {
                var b;
            ...
            function m(a) {
                if (a._.isBlockLike && a.name != "pre" && a.name != "textarea") {
                    ...
                    if (d && d.type == CKEDITOR.NODE_TEXT) (c = CKEDITOR.tools.rtrim(d.value)) ? d.value = c : a.children.length = b - 1;
                }
            }
            function p(b, d, c) {
                var d = d || k || o, e = k;
        ...
        CKEDITOR.htmlParser.fragment.prototype = {
            ...
            filterChildren: function(a, b, d) {
                if (this.childrenFilteredBy != a.id) {
                    ...
                    for (b = 0; b < this.children.length; b++) this.children[b].filter(a, d) === false && b--;
                }
            },
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                addRules: function(a, f) {
                    var d;
                    if (typeof f == "number") d = f; else if (f && "priority" in f) d = f.priority;
    ...
    (function() {
        function a(a, c) {
            ...
            function o(a, d) {
                return function(c) {
                    if (c.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (j = typeof d == "function" ? d(c) !== false : d) if (!v && !CKEDITOR.env.needsBrFiller && c.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) j = false; else if (!v && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || c.name in CKEDITOR.dtd.tr || c.name in CKEDITOR.dtd.$listItem)) j = false; else {
                            j = b(c);
            ...
            var w = {
                elements: {}
            }, v = c == "html", h = CKEDITOR.tools.extend({}, j), t;
            for (t in h) "#" in k[t] || delete h[t];
            for (t in h) w.elements[t] = o(v, a.config.fillEmptyBlocks !== false);
            w.root = o(v);
        ...
        function o(a, b) {
            for (var d = [], c = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = {
                id: 1
            }), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, c = [ /<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi ].concat(c), a = a.replace(/<\!--[\s\S]*?--\>/g, function(a) {
            ...
            a = a.replace(f, function(a, b, c) {
                return "<!--" + A + (b ? "{C}" : "") + encodeURIComponent(d[c]).replace(/--/g, "%2D%2D") + "-->";
            });
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node(), {
            ...
            filter: function(a, b) {
                ...
                for (h in g) {
                    ...
                    i && ((n = a.onAttribute(b, c, i, n)) === false ? delete g[i] : g[i] = n);
                }
    ...
    (function() {
        function a(a, e, f, n) {
            ...
            h.on("loaded", function() {
                b(h);
                n == CKEDITOR.ELEMENT_MODE_REPLACE && (h.config.autoUpdateElement && a.$.form) && h._attachToForm();
        ...
        function b(a) {
            var b = a.name, c = a.element, n = a.elementMode, h = a.fire("uiSpace", {
                space: "top",
                html: ""
        ...
        CKEDITOR.appendTo = function(b, c, f) {
            return a(b, c, f, CKEDITOR.ELEMENT_MODE_APPENDTO);
        };
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (!(a == c.mode || !f || !f[a])) {
                ...
                this._.modes[a](function() {
                    ...
                    m ? c.fire("unlockSnapshot") : a == "wysiwyg" && c.fire("saveSnapshot");
                    setTimeout(function() {
                        c.fire("mode");
                        b && b.call(c);
                    }, 0);
    ...
    (function() {
        function a(a) {
            ...
            if (b.config.autoParagraph !== false && b.activeEnterMode != CKEDITOR.ENTER_BR && b.editable().equals(e) && !d.block && j.collapsed && !j.getCommonAncestor().isReadOnly()) {
                ...
                e.guard = function(a) {
                    return !f(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly();
                };
        ...
        function e(a) {
            var b, c = a.getRanges()[0], d = a.root, e = {
                table: 1,
                ul: 1,
                ol: 1,
                dl: 1
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    var g, h;
                    if (f) for (;(g = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[g.getName()]) && (!h || !h[e]); ) if (g.getName() in CKEDITOR.dtd.span) b.splitElement(g); else if (b.checkStartOfBlock() && b.checkEndOfBlock()) {
                        b.setStartBefore(g);
                        b.collapse(true);
                        g.remove();
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in l) {
                                ...
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (f = b.getSelectedElement()) || (f = e(b))) {
                                    ...
                                    a.fire("saveSnapshot");
                                    d = 1;
                                } else if (k.collapsed) if ((h = g.block) && (m = h[c ? "getPrevious" : "getNext"](p)) && m.type == CKEDITOR.NODE_ELEMENT && m.is("table") && k[c ? "checkStartOfBlock" : "checkEndOfBlock"]()) {
                                    a.fire("saveSnapshot");
        ...
        var x = function() {
                ...
                for (var r = g[r.getName()], h = 0, i = c.getChildren(), m = i.count(), n = -1, q = -1, p = 0, s = e.contains(g.$list); h < m; ++h) {
                    ...
                    if (a(e)) {
                        ...
                        if (s && j in CKEDITOR.dtd.$list) l = l.concat(b(e, d)); else {
                            k = !!r[j];
                            if (j == "br" && e.data("cke-eol") && (!h || h == m - 1)) {
            ...
            return function(h, m, q) {
                var p = h.editor;
                h.getDocument();
                var s = p.getSelection().getRanges()[0], w = false;
                ...
                if (!s.checkReadOnly()) {
                    ...
                    if (t) {
                        ...
                        for (j(E, G); t < E.length; t++) {
                            ...
                            if (B) w = t > 0; else {
                                B = G.startPath();
                                if (!y.isBlock && m.editor.config.autoParagraph !== false && (m.editor.activeEnterMode != CKEDITOR.ENTER_BR && m.editor.editable().equals(B.blockLimit) && !B.block) && (Q = m.editor.activeEnterMode != CKEDITOR.ENTER_BR && m.editor.config.autoParagraph !== false ? m.editor.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : false)) {
                                    Q = x.createElement(Q);
                                    Q.appendBogus();
                                    G.insertNode(Q);
                    ...
                    if (!m.dontMoveCaret) {
                        for (H = a(K.startContainer) && K.startContainer.getChild(K.startOffset - 1); H && a(H) && !H.is(g.$empty); ) {
                            if (H.isBlockBoundary()) K.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END); else {
    ...
    (function() {
        ...
        var o = typeof window.getSelection != "function", u = 1;
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getType: o ? function() {
                ...
                if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE; else if (c.rangeCount == 1) {
                    ...
                    if (d == c.endContainer && d.nodeType == 1 && c.endOffset - c.startOffset == 1 && A[d.childNodes[c.startOffset].nodeName.toLowerCase()]) b = CKEDITOR.SELECTION_ELEMENT;
                }
                return a.type = b;
            },
            getRanges: function() {
                var a = o ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, g, k = b.duplicate(), j = 0, h = e.length - 1, w = -1, i, t; j <= h; ) {
                            ...
                            i = k.compareEndPoints("StartToStart", b);
                            if (i > 0) h = w - 1; else if (i < 0) j = w + 1; else return {
                                container: d,
                                offset: a(f)
                            };
                        }
                        ...
                        k.setEndPoint(i > 0 ? "StartToStart" : "EndToStart", b);
                        k = k.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!k) return {
                            container: d,
                            offset: a(f) + (i > 0 ? 0 : 1)
                        ...
                        return {
                            container: t,
                            offset: i > 0 ? -k : t.nodeValue.length + k
                        };
                    };
                    return function() {
                    ...
                    if (h) this.fake(h); else {
                        if (o) {
                            ...
                            for (p = 0; p < a.length; p++) {
                                ...
                                q.setStart(h.startContainer.$, h.startOffset);
                                try {
    ...
    (function() {
                ...
                for (p.getPosition(n) == CKEDITOR.POSITION_FOLLOWING && (p = 0); p; ) {
                    ...
                    if (p.equals(n)) {
                        ...
                        if (A) if ((A = p.getParent()) && ((A.getDtd() || CKEDITOR.dtd.span)[e] || h) && (!g.parentRule || g.parentRule(A))) {
                            if (!q && (!s || !CKEDITOR.dtd.$removeEmpty[s] || (p.getPosition(n) | L) == L)) {
                                q = b.clone();
                                q.setStartBefore(p);
                            }
                            s = p.type;
                    ...
                    if (i && q && !q.collapsed) {
                        for (var i = u(this, d), o = i.hasAttributes(), r = q.getCommonAncestor(), s = {}, A = {}, D = {}, I = {}, V, R, Y; i && r; ) {
                            if (r.getName() == e) {
                                for (V in g.attributes) if (!I[V] && (Y = r.getAttribute(R))) i.getAttribute(V) == Y ? A[V] = 1 : I[V] = 1;
        ...
        function s(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = l(this)[a.getName()], f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), g;
        ...
        CKEDITOR.style.prototype = {
            ...
            removeFromRange: function(a) {
                this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? n : this.type == CKEDITOR.STYLE_OBJECT ? e : null;
    ...
    CKEDITOR.dom.elementPath.prototype = {
        ...
        contains: function(a, c, b) {
            ...
            } : typeof a == "function" ? f = a : typeof a == "object" && (f = function(b) {
    ...
    (function() {
        function a(a, c, d) {
            ...
            c[d ? "endContainer" : "startContainer"] = g;
            return c;
        }
                    ...
                    getNextRange: function(g) {
                        ...
                        if (n && a.length > 1) {
                            ...
                            if (g) for (var i = 0; a[e + i + 1]; ) {
                                for (var m = n.document, g = 0, h = m.getById(d[i].endNode), m = m.getById(d[i + 1].startNode); ;) {
...
*/
                ...
                checkbox: function(b, a, d) {
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "span", null, null, function() {
                            ...
                            }, true), e = [], d = CKEDITOR.tools.getNextId() + "_label", g = {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                            for (var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", i = 0; i < a.items.length; i++) {
                                var j = a.items[i], h = j[2] !== void 0 ? j[2] : j[0], l = j[1] !== void 0 ? j[1] : j[0], m = CKEDITOR.tools.getNextId() + "_radio_input", n = m + "_label", m = CKEDITOR.tools.extend({}, a, {
                                    ...
                                    title: null,
                                    type: null
                                }, true), h = CKEDITOR.tools.extend({}, m, {
                                    title: h
                                }, true), o = {
                                    type: "radio",
    ...
    (function() {
        ...
        function V(a) {
            ...
            if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
                var h = a.getParentEditor(), m, k, i, o, j, n = CKEDITOR.tools.addFunction(function(f) {
                    ...
                    h.$.getElementsByTagName("iframe").length && (j = CKEDITOR.dom.element.createFromHtml('<div class="cke_dialog_resize_cover" style="height: 100%; position: absolute; width: 100%;"></div>'), 
                    h.append(j));
                    ...
                    CKEDITOR.env.ie6Compat && (h = q.getChild(0).getFrameDocument(), h.on("mousemove", e), 
                    h.on("mouseup", d));
        ...
        function J(a) {
            ...
            f ? f.show() : (g = [ '<div tabIndex="-1" style="position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", g, "; top: 0px; left: 0px; ", !CKEDITOR.env.ie6Compat ? "background-color: " + e : "", '" class="cke_dialog_background_cover">' ], 
            CKEDITOR.env.ie6Compat && (e = "<html><body style=\\'background-color:" + e + ";\\'></body></html>", 
            g.push('<iframe hidefocus="true" frameborder="0" id="cke_dialog_background_iframe" src="javascript:'), 
            g.push("void((function(){" + encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.write( '" + e + "' );document.close();") + "})())"), 
            ...
            g.push("</div>"), f = CKEDITOR.dom.element.createFromHtml(g.join("")), f.setOpacity(void 0 != d ? d : .5), 
            f.on("keydown", E), f.on("keypress", E), f.on("keyup", E), f.appendTo(CKEDITOR.document.getBody()), 
            w[c] = f);
        ...
        function K(a) {
            q && (a.focusManager.remove(q), a = CKEDITOR.document.getWindow(), q.hide(), a.removeListener("resize", F), 
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            function e(a) {
                ...
                if (!(1 > b.length)) {
                    ...
                    for (var d = c = (c + a + b.length) % b.length; a && !b[d].isFocusable() && !(d = (d + a + b.length) % b.length, 
                    d == c); ) ;
                    b[d].focus();
            ...
            function d(b) {
                if (l == CKEDITOR.dialog._.currentTop) {
                    ...
                    o = j = 0;
                    if (9 == c || c == CKEDITOR.SHIFT + 9) c = c == CKEDITOR.SHIFT + 9, l._.tabBarMode ? (c = c ? t.call(l) : u.call(l), 
                    l.selectPage(c), l._.tabs[c][0].focus()) : e(c ? -1 : 1), o = 1; else if (c == CKEDITOR.ALT + 121 && !l._.tabBarMode && 1 < l.getPageCount()) l._.tabBarMode = !0, 
                    l._.tabs[l._.currentTabId][0].focus(), o = 1; else if ((37 == c || 39 == c) && l._.tabBarMode) c = c == (d ? 39 : 37) ? t.call(l) : u.call(l), 
                    l.selectPage(c), l._.tabs[c][0].focus(), o = 1; else if ((13 == c || 32 == c) && l._.tabBarMode) this.selectPage(this._.currentTabId), 
            ...
            if (!("removeDialogTabs" in a._) && a.config.removeDialogTabs) {
                ...
                for (k = 0; k < h.length; k++) if (m = h[k].split(":"), 2 == m.length) {
                    var n = m[0];
                    i[n] || (i[n] = []);
                    i[n].push(m[1]);
                }
            ...
            this.on("cancel", function(b) {
                p(function(c) {
                    if (c.isChanged()) return !a.config.dialog_noConfirmCancel && !confirm(a.lang.common.confirmCancel) && (b.data.hide = !1), 
                    !0;
                });
            }, this, null, 0);
            ...
            this.on("show", function() {
                c();
                if (a.config.dialog_startupFocusTab && 1 < l._.pageCount) l._.tabBarMode = !0, l._.tabs[l._.currentTabId][0].focus(); else if (!this._.hasFocus) if (this._.currentFocusIndex = -1, 
                f.onFocus) {
            ...
            this.parts.tabs.on("click", function(a) {
                ...
                this._.tabBarMode && (this._.tabBarMode = !1, this._.currentFocusIndex = -1, e(1)), 
                a.data.preventDefault());
            }, this);
            k = [];
        ...
        CKEDITOR.dialog.prototype = {
            ...
            move: function(a, b, c) {
                ...
                d && (g = this.getSize(), a = CKEDITOR.document.getWindow().getViewPaneSize().width - g.width - a), 
                b = {
                    top: (0 < b ? b : 0) + "px"
            ...
            show: function() {
                ...
                J(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop, this._.parentDialog.getElement().getFirst().$.style.zIndex -= Math.floor(this._.editor.config.baseFloatZIndex / 2), 
            ...
            addPage: function(a) {
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    }, b), d = this._.contents[a.id] = {}, g = e.getChild(), f = 0; e = g.shift(); ) !e.notAllowed && ("hbox" != e.type && "vbox" != e.type) && f++, 
                    d[e.id] = e, "function" == typeof e.getChild && g.push.apply(g, e.getChild());
                    f || (a.hidden = !0);
            ...
            hidePage: function(a) {
                ...
                b && (1 != this._.pageCount && b.isVisible()) && (a == this._.currentTabId && this.selectPage(t.call(this)), 
        ...
        var F, w = {}, q, s = {}, M = function(a) {
            ...
            if ((b = s[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (e ? "SHIFT+" : "") + d]) && b.length) b = b[b.length - 1], 
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function(a, b, c, e, d, g, f) {
                    if (!(4 > arguments.length)) {
                        ...
                        this.id = b.id;
                        b.requiredContent && !a.getParentEditor().filter.check(b.requiredContent) && (k.display = "none", 
                        this.notAllowed = !0);
                        i.id = j;
                        var n = {};
                        ...
                        CKEDITOR.tools.extend(this, b);
                        this.keyboardFocusable && (this.tabIndex = b.tabIndex || 0, this.focusIndex = a._.focusList.push(this) - 1, 
                        this.on("focus", function() {
                ...
                hbox: function(a, b, c, e, d) {
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var g = this._.children = b, f = d && d.widths || null, h = d && d.height || null, m, k = {
                            role: "presentation"
                        };
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function(a, b) {
                ...
                if ("function" == typeof e) c = this._.storedDialogs || (this._.storedDialogs = {}), 
        ...
        function m(a) {
            return {
                ...
                refresh: function(a, d) {
                    ...
                    c && (b = b ? c.getComputedStyle("direction") : c.getStyle("direction") || c.getAttribute("dir"), 
            ...
            exec: function(g) {
                ...
                if (c) {
                    ...
                    if (a == CKEDITOR.TRISTATE_OFF) {
                        ...
                        1 > e.length && (a = g.document.createElement(g.config.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), 
                        b = h.shift(), c.insertNode(a), a.append(new CKEDITOR.dom.text("\ufeff", g.document)), 
                        c.moveToBookmark(b), c.selectNodeContents(a), c.collapse(!0), b = c.createBookmark(), 
                        e.push(a), h.unshift(b));
                        d = e[0].getParent();
                        c = [];
                        ...
                        a = [];
                        e = [];
                        for (d = {}; 0 < b.length; ) f = b.shift(), c = f.getParent(), f.getPrevious() ? f.getNext() ? (f.breakParent(f.getParent()), 
                        e.push(f.getNext())) : f.remove().insertAfter(c) : f.remove().insertBefore(c), c.getCustomData("blockquote_processed") || (e.push(c), 
                        CKEDITOR.dom.element.setMarker(d, c, "blockquote_processed", !0)), a.push(f);
                        CKEDITOR.dom.element.clearAllMarkers(d);
                        ...
                        if (g.config.enterMode == CKEDITOR.ENTER_BR) for (c = !0; a.length; ) if (f = a.shift(), 
                        "div" == f.getName()) {
    ...
    (function() {
        function v(b) {
            ...
            function j() {
                if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
                    ...
                    if (e.getType() == CKEDITOR.SELECTION_ELEMENT && (a = e.getSelectedElement())) d = e.getRanges()[0], 
                    c = b.document.createText(""), c.insertBefore(a), d.setStartBefore(c), d.setEndAfter(a), 
                    e.selectRanges([ d ]), setTimeout(function() {
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    CKEDITOR.env.webkit ? (j.append(k), k.addClass("cke_editable"), j.is("body") || (f = "static" != j.getComputedStyle("position") ? j : CKEDITOR.dom.element.get(j.$.offsetParent), 
                    f = f.getDocumentPosition().y)) : j.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(k);
                    k.setStyles({
                        position: "absolute",
            ...
            b.getClipboardData = function(a, d) {
                ...
                !1 === s() && (b.removeListener("paste", c), g && b.fire("pasteDialog", l) ? (b.on("pasteDialogCommit", j), 
        ...
        function x(b, a) {
            ...
            if (a.match(/^[^<]$/)) return a;
            CKEDITOR.env.webkit && -1 < a.indexOf("<div>") && (a = a.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "<br>").replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "<div></div>"), 
            a.match(/<div>(<br>|)<\/div>/) && (a = "<p>" + a.replace(/(<div>(<br>|)<\/div>)+/g, function(a) {
                return c(a.split("</div><div>").length + 1);
            }) + "</p>"), a = a.replace(/<\/div><div>/g, "<br>"), a = a.replace(/<\/?div>/g, ""));
            CKEDITOR.env.gecko && b.enterMode != CKEDITOR.ENTER_BR && (CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "<br>")), 
            -1 < a.indexOf("<br><br>") && (a = "<p>" + a.replace(/(<br>){2,}/g, function(a) {
                return c(a.length / 4);
            }) + "</p>"));
            return o(b, a);
        }
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                if (this.modes) {
                    var j = {}, g = function() {
                        var b = a.mode;
                        b && (b = this.modes[b] ? void 0 != j[b] ? j[b] : CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, 
        ...
        CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
            ...
            _: {
                markItem: function(a) {
                    ...
                    CKEDITOR.env.webkit && a.getDocument().getWindow().focus(), a.focus(), this.onMark && this.onMark(a));
                }
            },
            proto: {
                show: function() {
                ...
                onKeyDown: function(a, b) {
                    ...
                    switch (d) {
                      ...
                      case "click":
                      case "mouseup":
                        return e = this._.focusIndex, (c = 0 <= e && this.element.getElementsByTag("a").getItem(e)) && (c.$[d] ? c.$[d]() : c.$["on" + d]()), 
                        !1;
                    }
                    return !0;
                }
    ...
    (function() {
        function r(a, b, c, i, f) {
            ...
            h || (h = g[f] = new CKEDITOR.ui.panel(b, i), h.element = c.append(CKEDITOR.dom.element.createFromHtml(h.render(a), b)), 
            h.element.setStyles({
                display: "none",
                position: "absolute"
            }));
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                showAsChild: function(a, b, c, g, f, h) {
                    this._.activeChild == a && a._.panel._.offsetParentId == c.getId() || (this.hideChild(), 
                    a.onHide = CKEDITOR.tools.bind(function() {
                        CKEDITOR.tools.setTimeout(function() {
                            this._.focused || this.hide();
                        }, 0, this);
                    }, this), this._.activeChild = a, this._.focused = !1, a.showBlock(b, c, g, f, h), 
                ...
                c.ui.add(l, CKEDITOR.UI_PANELBUTTON, {
                    ...
                    onOpen: function() {
                        ...
                        if (a) {
                            ...
                            do b = a && a.getComputedStyle("back" == g ? "background-color" : "color") || "transparent"; while ("back" == g && "transparent" == b && a && (a = a.getParent()));
                ...
                onShow: function() {
                    ...
                    for (var e = 0; e < k.length; e++) {
                        ...
                        if (j) for (var i in j) {
                            ...
                            if (f && (!f.command || this.editor.getCommand(f.command).state)) f.state = j[i], 
                            this.add(f);
                        }
                    }
                },
            ...
            proto: {
                ...
                show: function(a, b, c, k) {
                    ...
                    for (var d = j.elementPath(), d = [ '<div class="cke_menu' + (d && d.direction() != j.lang.dir ? " cke_mixed_dir_content" : "") + '" role="presentation">' ], h = e.length, m = h && e[0].group, l = 0; l < h; l++) {
                        var n = e[l];
                        m != n.group && (d.push('<div class="cke_menuseparator" role="separator"></div>'), 
                        m = n.group);
                        n.render(this, l, d);
                    }
                    d.push("</div>");
                ...
                if (!a.blockless) {
                    ...
                    a.addCommand("removediv", {
                        ...
                        exec: function(a) {
                            ...
                            e.collapsed ? c(b.getStartElement()) : (e = new CKEDITOR.dom.walker(e), e.evaluator = c, 
                            e.lastForward());
    ...
    (function() {
        function w(a) {
            ...
            function g() {
                var b = {}, c, f, e;
                for (c in a.ui.items) f = a.ui.items[c], e = f.toolbar || "others", e = e.split(","), 
                f = e[0], e = parseInt(e[1] || -1, 10), b[f] || (b[f] = []), b[f].push({
                    name: c,
                    order: e
                });
            ...
            function h(b) {
                var a = [], e, d, h;
                for (e = 0; e < b.length; ++e) d = b[e], h = {}, "/" == d ? a.push(d) : CKEDITOR.tools.isArray(d) ? (c(h, CKEDITOR.tools.clone(d)), 
                a.push(h)) : d.items && (c(h, CKEDITOR.tools.clone(d.items)), h.name = d.name, a.push(h));
                return a;
            }
                ...
                var d, g = function(c, h) {
                    ...
                    switch (h) {
                      ...
                      case CKEDITOR.SHIFT + 9:
                        for (;!b || !b.items.length; ) if (b = 9 == h ? (b ? b.next : c.toolbar.next) || a.toolbox.toolbars[0] : (b ? b.previous : c.toolbar.previous) || a.toolbox.toolbars[a.toolbox.toolbars.length - 1], 
                        b.items.length) for (c = b.items[d ? b.items.length - 1 : 0]; c && !c.focus; ) (c = d ? c.previous : c.next) || (b = 0);
                        c && c.focus();
                        return !1;
                            ...
                            if (m) if (e && (b.push("</span>"), j = e = 0), "/" === m) b.push('<span class="cke_toolbar_break"></span>'); else {
                                ...
                                for (var t = 0; t < s.length; t++) {
                                    ...
                                    if (p) if (p.type == CKEDITOR.UI_SEPARATOR) j = e && p; else {
                                        ...
                                        n ? e || (b.push('<span class="cke_toolgroup" role="presentation">'), e = 1) : e && (b.push("</span>"), 
                                        e = 0);
                                        i = function(c) {
                                            c = c.render(a, b);
                                            q = l.items.push(c) - 1;
                        ...
                        if (a.config.toolbarCanCollapse && a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                            ...
                            a.addCommand("toolbarCollapse", {
                                ...
                                exec: function(b) {
                                    ...
                                    g ? (c.show(), a.removeClass("cke_toolbox_collapser_min"), a.setAttribute("title", b.lang.toolbar.toolbarCollapse)) : (c.hide(), 
                                    a.addClass("cke_toolbox_collapser_min"), a.setAttribute("title", b.lang.toolbar.toolbarExpand));
                ...
                a.on("destroy", function() {
                    if (this.toolbox) {
                        ...
                        for (a = this.toolbox.toolbars; d < a.length; d++) {
                            e = a[d].items;
                            for (b = 0; b < e.length; b++) g = e[b], g.clickFn && CKEDITOR.tools.removeFunction(g.clickFn), 
    ...
    (function() {
        ...
        function n(a, c) {
            ...
            a.on("selectionChange", function() {
                ...
                e = e.length;
                for (b = 0; b < e; b++) f = g[b], c = a.lang.elementspath.eleTitle.replace(/%1/, f), 
                f = v.output({
                    id: n + b,
                    label: c,
                    text: f,
    ...
    (function() {
        function l(c, e, b) {
            ...
            "wysiwyg" == c.mode && (e || (e = c.activeEnterMode), c.elementPath().isContextFor("p") || (e = CKEDITOR.ENTER_BR, 
            b = 1), c.fire("saveSnapshot"), e == CKEDITOR.ENTER_BR ? o(c, e, null, b) : p(c, e, null, b), 
            c.fire("saveSnapshot"));
        }
        function q(c) {
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function(c, e, b, h) {
                if (b = b || q(c)) {
                    var f = b.document, j = b.checkStartOfBlock(), i = b.checkEndOfBlock(), a = c.elementPath(b.startContainer).block, k = e == CKEDITOR.ENTER_DIV ? "div" : "p", d;
                    if (j && i) {
                        if (a && (a.is("li") || a.getParent().is("li"))) {
                            b = a.getParent();
                            d = b.getParent();
                            var h = !a.hasPrevious(), m = !a.hasNext(), k = c.getSelection(), g = k.createBookmarks(), j = a.getDirection(1), i = a.getAttribute("class"), n = a.getAttribute("style"), l = d.getDirection(1) != j, c = c.enterMode != CKEDITOR.ENTER_BR || l || n || i;
                            if (d.is("li")) if (h || m) a[h ? "insertBefore" : "insertAfter"](d); else a.breakParent(d); else {
                                if (c) if (d = f.createElement(e == CKEDITOR.ENTER_P ? "p" : "div"), l && d.setAttribute("dir", j), 
                                n && d.setAttribute("style", n), i && d.setAttribute("class", i), a.moveChildren(d), 
                                h || m) d[h ? "insertBefore" : "insertAfter"](b); else a.breakParent(b), d.insertAfter(b); else if (a.appendBogus(!0), 
                                h || m) for (;f = a[h ? "getFirst" : "getLast"](); ) f[h ? "insertBefore" : "insertAfter"](b); else for (a.breakParent(b); f = a.getLast(); ) f.insertAfter(b);
                                a.remove();
                            }
                            k.selectBookmarks(g);
                            return;
                    ...
                    if (i = b.splitBlock(k)) {
                        ...
                        c = i.wasStartOfBlock;
                        j = i.wasEndOfBlock;
                        if (a) g = a.getParent(), g.is("li") && (a.breakParent(g), a.move(a.getNext(), 1)); else if (e && (g = e.getParent()) && g.is("li")) e.breakParent(g), 
                        g = e.getNext(), b.moveToElementEditStart(g), e.move(e.getPrevious());
                        if (!c && !j) a.is("li") && (d = b.clone(), d.selectNodeContents(a), d = new CKEDITOR.dom.walker(d), 
                        ...
                        }, (g = d.next()) && (g.type == CKEDITOR.NODE_ELEMENT && g.is("ul", "ol")) && (CKEDITOR.env.needsBrFiller ? f.createElement("br") : f.createText(" ")).insertBefore(g)), 
                        a && b.moveToElementEditStart(a); else {
                            if (e) {
                                if (e.is("li") || !r.test(e.getName()) && !e.is("pre")) d = e.clone();
                            } else a && (d = a.clone());
                            d ? h && !d.is("li") && d.renameNode(k) : g && g.is("li") ? d = g : (d = f.createElement(k), 
                            e && (m = e.getDirection()) && d.setAttribute("dir", m));
                            if (f = i.elementPath) {
                                h = 0;
                                for (k = f.elements.length; h < k; h++) {
                                    g = f.elements[h];
                            ...
                            if (CKEDITOR.env.ie && c && (!j || !e.getChildCount())) b.moveToElementEditStart(j ? e : d), 
                            b.select();
                            b.moveToElementEditStart(c && !j ? a : d);
                        }
                        b.select();
                        b.scrollIntoView();
                    }
            ...
            enterBr: function(c, e, b, h) {
                if (b = b || q(c)) {
                    var f = b.document, j = b.checkEndOfBlock(), i = new CKEDITOR.dom.elementPath(c.getSelection().getStartElement()), a = i.block, k = a && i.block.getName();
                    !h && "li" == k ? p(c, e, b, h) : (!h && j && r.test(k) ? (j = a.getDirection()) ? (f = f.createElement("div"), 
                    f.setAttribute("dir", j), f.insertAfter(a), b.setStart(f, 0)) : (f.createElement("br").insertAfter(a), 
                    CKEDITOR.env.gecko && f.createText("").insertAfter(a), b.setStartAt(a.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (c = "pre" == k && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? f.createText("\r") : f.createElement("br"), 
                    b.deleteContents(), b.insertNode(c), CKEDITOR.env.needsBrFiller ? (f.createText("\ufeff").insertAfter(c), 
                    j && (a || i.blockLimit).appendBogus(), c.getNext().$.nodeValue = "", b.setStartAt(c.getNext(), CKEDITOR.POSITION_AFTER_START)) : b.setStartAt(c, CKEDITOR.POSITION_AFTER_END)), 
                    b.collapse(!0), b.select(), b.scrollIntoView());
                }
            }
        };
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
        popup: function(e, a, b, d) {
            ...
            if (!c) return !1;
            try {
                -1 == navigator.userAgent.toLowerCase().indexOf(" chrome/") && (c.moveTo(g, f), 
                c.resizeTo(a, b)), c.focus(), c.location.href = e;
            } catch (h) {
    ...
    (function() {
        ...
        function j(a, c, d, b) {
            if (b && b.length) for (var e, g = b.length; g--; ) if (e = b[g], ("hbox" == e.type || "vbox" == e.type || "fieldset" == e.type) && j(a, c, d, e.children), 
            e.filebrowser) if ("string" == typeof e.filebrowser && (e.filebrowser = {
            ...
            } else if ("QuickUpload" == e.filebrowser.action && e["for"] && (f = e.filebrowser.url, 
            void 0 === f && (f = a.config["filebrowser" + i(c) + "UploadUrl"], void 0 === f && (f = a.config.filebrowserUploadUrl)), 
            f)) {
                var h = e.onClick;
        ...
        function n(a, c) {
            ...
            if (!("function" == typeof c && !1 === c.call(this._.filebrowserSe)) && !(e && !1 === e.call(this._.filebrowserSe, a, c)) && ("string" == typeof c && c && alert(c), 
            a && (b = this._.filebrowserSe, d = b.getDialog(), b = b.filebrowser.target || null))) if (b = b.split(":"), 
            e = d.getContentElement(b[0], b[1])) e.setValue(a), d.selectPage(b[0]);
        }
    ...
    (function() {
        ...
        CKEDITOR.editor.prototype.createFakeElement = function(a, b, c, d) {
            ...
            d && (b["data-cke-resizable"] = d, c = new i(), d = a.getAttribute("width"), a = a.getAttribute("height"), 
            d && (c.rules.width = h(d)), a && (c.rules.height = h(a)), c.populate(b));
        ...
        CKEDITOR.editor.prototype.createFakeParserElement = function(a, b, c, d) {
            ...
            CKEDITOR.env.hc || (b.src = CKEDITOR.tools.transparentImageData);
            c && (b["data-cke-real-element-type"] = c);
            d && (b["data-cke-resizable"] = d, d = a.attributes, a = new i(), c = d.width, d = d.height, 
            void 0 != c && (a.rules.width = h(c)), void 0 != d && (a.rules.height = h(d)), a.populate(b));
    ...
    (function() {
        function q(a) {
            var i = a.config, l = a.fire("uiSpace", {
                space: "top",
                html: ""
            }).html, o = function() {
                function f(a, c, e) {
                ...
                var j, r, k, c, h, m, s, l = i.floatSpaceDockedOffsetX || 0, n = i.floatSpaceDockedOffsetY || 0, p = i.floatSpacePinnedOffsetX || 0, q = i.floatSpacePinnedOffsetY || 0;
                return function(d) {
                    if (r = a.editable()) if (d && "focus" == d.name && b.show(), b.removeStyle("left"), 
                    b.removeStyle("right"), k = b.getClientRect(), c = r.getClientRect(), h = g.getViewPaneSize(), 
                    m = k.height, s = "pageXOffset" in g.$ ? g.$.pageXOffset : CKEDITOR.document.$.documentElement.scrollLeft, 
                    j) {
                        ...
                        k.width > h.width ? (d = "left", f = 0) : (f = "left" == d ? 0 < c.left ? c.left : 0 : c.right < h.width ? h.width - c.right : 0, 
                        f + k.width > h.width && (d = "left" == d ? "right" : "left", f = 0));
            ...
            CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
                ...
                proto: {
                    ...
                    showAll: function() {
                        ...
                        for (var e in b) a = c.getById(b[e]), d = a.getNext(), a.setStyle("display", ""), 
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                setValue: function(a, b) {
                    ...
                    d && (!a && !b ? (b = this.label, d.addClass("cke_combo_inlinelabel")) : d.removeClass("cke_combo_inlinelabel"), 
        ...
        init: function(a) {
            ...
            a.contextMenu && (!a.blockless && a.contextMenu.addListener(function(d, c, a) {
                ...
                if (d && !d.isReadOnly()) {
                    ...
                    if (c == "img" && d.data("cke-real-element-type") == "hiddenfield") return {
            ...
            a.on("doubleclick", function(d) {
                ...
                if (!a.blockless && c.is("form")) d.data.dialog = "form"; else if (c.is("select")) d.data.dialog = "select"; else if (c.is("textarea")) d.data.dialog = "textarea"; else if (c.is("img") && c.data("cke-real-element-type") == "hiddenfield") d.data.dialog = "hiddenfield"; else if (c.is("input")) {
        ...
        init: function(a) {
            if (!a.blockless) {
                for (var f = a.config, c = a.lang.format, j = f.format_tags.split(";"), d = {}, k = 0, l = [], g = 0; g < j.length; g++) {
                    ...
                    if (!a.filter.customConfig || a.filter.check(i)) k++, d[h] = i, d[h]._.enterMode = a.config.enterMode, 
                    l.push(i);
                }
    ...
    CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
        ...
        proto: {
            openTag: function(b) {
                ...
                this._.indent ? this.indentation() : a && a.breakBeforeOpen && (this.lineBreak(), 
                this.indentation());
            ...
            openTagClose: function(b, a) {
                ...
                a ? (this._.output.push(this.selfClosingEnd), c && c.breakAfterClose && (this._.needsSpace = c.needsSpace)) : (this._.output.push(">"), 
            ...
            attribute: function(b, a) {
                "string" == typeof a && (this.forceSimpleAmpersand && (a = a.replace(/&amp;/g, "&")), 
            ...
            closeTag: function(b) {
                ...
                this._.indent ? this.indentation() : a && a.breakBeforeClose && (this.lineBreak(), 
                this.indentation());
                this._.output.push("</", b, ">");
    ...
    (function() {
        function k(a) {
            ...
            CKEDITOR.env.gecko && (c.contentEditable = !1, 2e4 > CKEDITOR.env.version && (c.innerHTML = c.innerHTML.replace(/^.*<\!-- cke-content-start --\>/, ""), 
            setTimeout(function() {
            ...
            proto: {
                setData: function(a, d) {
                    ...
                    if (d) this.setHtml(a), b.fire("dataReady"); else {
                        ...
                        e ? (/<body[\s|>]/.test(a) || (a = "<body>" + a), /<html[\s|>]/.test(a) || (a = "<html>" + a + "</html>"), 
                        /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$&<title></title>")) : a = a.replace(/<html[^>]*>/, "$&<head><title></title></head>"), 
                        h && (a = a.replace(/<head>/, "$&" + h)), a = a.replace(/<\/head\s*>/, f + "$&"), 
                        a = g + a) : a = c.docType + '<html dir="' + c.contentsLangDirection + '" lang="' + (c.contentsLanguage || b.langCode) + '"><head><title>' + this._.docTitle + "</title>" + h + f + "</head><body" + (c.bodyId ? ' id="' + c.bodyId + '"' : "") + (c.bodyClass ? ' class="' + c.bodyClass + '"' : "") + ">" + a + "</body></html>";
                ...
                function a(a) {
                    ...
                    if (d) {
                        if ("left" == a || "right" == a) d.on("exec", function(d) {
                            var c = e(b), g;
                            c && (g = f(c), g == a ? (c.removeStyle("float"), a == f(c) && c.removeAttribute("align")) : c.setStyle("float", a), 
                            d.cancel());
                        });
                        d.on("refresh", function(d) {
                            var c = e(b);
                            c && (c = f(c), this.setState(c == a ? CKEDITOR.TRISTATE_ON : "right" == a || "left" == a ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED), 
                            d.cancel());
                        });
                    }
                }
                        ...
                        20: {
                            refresh: function(a, b) {
                                ...
                                if (d) {
                                    var c;
                                    c = d;
                                    var e = e.$.className.match(this.classNameRegex), g = this.isIndent;
    ...
    (function() {
        function s(e) {
            function g(b) {
                ...
                for (var h = n.isIndent ? 1 : -1, a = f[0], f = f[f.length - 1], c = CKEDITOR.plugins.list.listToArray(b, o), g = c[f.getCustomData("listarray_index")].indent, a = a.getCustomData("listarray_index"); a <= f.getCustomData("listarray_index"); a++) if (c[a].indent += h, 
                0 < h) {
                    var l = c[a].parent;
                ...
                if (m && m.length) for (a = 0; a < m.length; a++) {
                    for (j = b = m[a]; (j = j.getNext()) && j.is && j.getName() in k; ) CKEDITOR.env.needsNbspFiller && !b.getFirst(t) && b.append(d.document.createText(" ")), 
                    b.append(j);
                    b.insertAfter(i);
                }
            ...
            for (var n = this, o = this.database, k = this.context, l = e.getSelection(), l = (l && l.getRanges()).createIterator(), d; d = l.getNextRange(); ) {
                ...
                if (!b) {
                    ...
                    c && (c.type == CKEDITOR.NODE_ELEMENT && c.getName() in k) && (d.setStartAt(c, CKEDITOR.POSITION_AFTER_START), 
                    d.setEndAt(c, CKEDITOR.POSITION_BEFORE_END), b = c);
                }
                b && (d.startContainer.type == CKEDITOR.NODE_ELEMENT && d.startContainer.getName() in k) && (c = new CKEDITOR.dom.walker(d), 
                c.evaluator = i, d.startContainer = c.next());
    ...
    (function() {
        ...
        function j(a) {
            ...
            for (var h = new CKEDITOR.dom.walker(b), d; d = h.next(); ) if (d.type == CKEDITOR.NODE_ELEMENT) if (!d.equals(a.data.node) && d.getDirection()) b.setStartAfter(d), 
            h = new CKEDITOR.dom.walker(b); else {
    ...
    CKEDITOR.plugins.add("menubutton", {
        ...
        onLoad: function() {
            var d = function(c) {
                ...
                a.state !== CKEDITOR.TRISTATE_DISABLED && (a.on && b ? b.hide() : (a.previousState = a.state, 
                b || (b = a.menu = new CKEDITOR.menu(c, {
                    panel: {
                        className: "cke_menu_panel",
                        attributes: {
                    ...
                    a.on = 0;
                }, this), this.onMenu && b.addListener(this.onMenu)), this.setState(CKEDITOR.TRISTATE_ON), 
                a.on = 1, setTimeout(function() {
    ...
    (function() {
        CKEDITOR.plugins.add("language", {
            ...
            init: function(a) {
                ...
                for (f = 0; f < b.length; f++) g = b[f].split(":"), h = g[0], i = "language_" + h, 
                e[i] = {
                    label: g[1],
                    langId: h,
                    group: "language",
    ...
    (function() {
        ...
        function o(c, b) {
            ...
            for (var g = 0; g < f.length; g++) a = f[g].toLowerCase(), e = b[a], 0 < g && d.push(","), 
            d.push("'", e ? m(encodeURIComponent(b[a])) : "", "'");
            d.push(")");
            return d.join("");
        }
        function l(c) {
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function(c) {
                ...
                return a && a.is("a") ? a : (b = b.getRanges()[0]) ? (b.shrink(CKEDITOR.SHRINK_TEXT), 
                c.elementPath(b.getCommonAncestor()).contains("a", 1)) : null;
            },
            ...
            parseLinkAttributes: function(c, b) {
                ...
                a.match(p) && ("encode" == e ? a = a.replace(w, function(a, b, c) {
                    ...
                    if (b == f.name) {
                        g.type = "email";
                        for (var a = g.email = {}, b = /(^')|('$)/g, c = c.match(/[^,\s]+/g), d = c.length, e, h, i = 0; i < d; i++) e = decodeURIComponent, 
                        h = c[i].replace(b, "").replace(/\\'/g, "'"), h = e(h), e = f.params[i].toLowerCase(), 
                        a[e] = h;
                ...
                } else if (a && (d = a.match(u))) g.type = "url", g.url = {}, g.url.protocol = d[1], 
                g.url.url = d[2];
                if (b) {
                  ...
                  case "email":
                    ...
                    switch (a) {
                      ...
                      case "encode":
                        ...
                        i && d.push("body=" + i);
                        d = d.length ? "?" + d.join("&") : "";
                        "encode" == a ? (a = [ "javascript:void(location.href='mailto:'+", n(e) ], d && a.push("+'", m(d), "'"), 
                        a.push(")")) : a = [ "mailto:", e, d ];
                        break;
    ...
    (function() {
        function E(c, j, e) {
            ...
            for (var k = CKEDITOR.plugins.list.listToArray(j.root, e), g = [], h = 0; h < j.contents.length; h++) {
                var f = j.contents[h];
                if ((f = f.getAscendant("li", !0)) && !f.getCustomData("list_item_processed")) g.push(f), 
                CKEDITOR.dom.element.setMarker(e, f, "list_item_processed", !0);
            }
            f = null;
        ...
        function A(c, j, e, b) {
            for (var k, g; k = c[b ? "getLast" : "getFirst"](F); ) (g = k.getDirection(1)) !== j.getDirection(1) && k.setAttribute("dir", g), 
            k.remove(), e ? k[b ? "insertBefore" : "insertAfter"](e) : j.append(k, b);
        }
        function B(c) {
            var j;
            (j = function(e) {
                var b = c[e ? "getPrevious" : "getNext"](q);
                b && (b.type == CKEDITOR.NODE_ELEMENT && b.is(c.getName())) && (A(c, b, null, !e), 
                c.remove(), c = b);
            })();
            j(1);
        }
        ...
        CKEDITOR.plugins.list = {
            ...
            arrayToList: function(c, j, e, b, k) {
                ...
                for (var g, h = c[e].parent.getDocument(), f = new CKEDITOR.dom.documentFragment(h), a = null, d = e, m = Math.max(c[e].indent, 0), i = null, n, l, p = b == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    ...
                    if (o.indent == m) {
                        if (!a || c[d].parent.getName() != a.getName()) a = c[d].parent.clone(!1, 1), k && a.setAttribute("dir", k), 
                        f.append(a);
                        ...
                        d++;
                    } else if (o.indent == Math.max(m, 0) + 1) o = c[d - 1].element.getDirection(1), 
                    d = CKEDITOR.plugins.list.arrayToList(c, null, d, b, o != n ? n : null), !i.getChildCount() && (CKEDITOR.env.needsNbspFiller && !(7 < h.$.documentMode)) && i.append(h.createText(" ")), 
                    i.append(d.listNode), d = d.nextIndex; else if (-1 == o.indent && !e && g) {
                        ...
                        for (g = 0; g < x; g++) if (s = o.contents[g], D(s) && 1 < x) w ? t = s.clone(1, 1) : i.append(s.clone(1, 1)); else if (s.type == CKEDITOR.NODE_ELEMENT && s.isBlockBoundary()) {
                        ...
                        } else w ? (l || (l = h.createElement(p), i.append(l), a && l.setAttribute("dir", n)), 
                        v && l.setAttribute("style", v), z && l.setAttribute("class", z), t && (l.append(t), 
                        t = null), l.append(s.clone(1, 1))) : i.append(s.clone(1, 1));
                        t && ((l || i).append(t), t = null);
                        i.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && d != c.length - 1 && (CKEDITOR.env.needsBrFiller && (n = i.getLast()) && (n.type == CKEDITOR.NODE_ELEMENT && n.is("br")) && n.remove(), 
                        n = i.getLast(q), (!n || !(n.type == CKEDITOR.NODE_ELEMENT && n.is(CKEDITOR.dtd.$block))) && i.append(h.createElement("br")));
                ...
                if (j) for (c = f.getFirst(); c; ) {
                    if (c.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(j, c), 
                    c.getName() in CKEDITOR.dtd.$listItem && (e = c, h = k = b = void 0, b = e.getDirection()))) {
        ...
        x.prototype = {
            exec: function(c) {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    ...
                    } else j.enterMode == CKEDITOR.ENTER_BR ? k.appendBogus() : b[0].fixBlock(1, j.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), 
                    e.selectRanges(b);
                }
                ...
                for (n = []; 0 < k.length; ) if (d = k.shift(), this.state == CKEDITOR.TRISTATE_OFF) if (r[d.root.getName()]) {
                    ...
                    i = [];
                    for (a = 0; a < f.contents.length; a++) if (l = f.contents[a], (l = l.getAscendant("li", !0)) && !l.getCustomData("list_item_processed")) i.push(l), 
                    ...
                    f = [];
                    1 == i.length && i[0].equals(a.root) && (d = b.createElement("div"), i[0].moveChildren && i[0].moveChildren(d), 
                    i[0].append(d), i[0] = d);
                    ...
                    if (!(1 > f.length)) {
                        ...
                        g.push(l);
                        for (p = g = void 0; f.length; ) g = f.shift(), p = b.createElement("li"), g.is("pre") || H.test(g.getName()) || "false" == g.getAttribute("contenteditable") ? g.appendTo(p) : (g.copyAttributes(p), 
                        d && g.getDirection() && (p.removeStyle("direction"), p.removeAttribute("dir")), 
                        g.moveChildren(p), g.remove()), p.appendTo(l);
        ...
        CKEDITOR.plugins.add("list", {
            requires: "indentlist",
            init: function(c) {
                c.blockless || (c.addCommand("numberedlist", new x("numberedlist", "ol")), c.addCommand("bulletedlist", new x("bulletedlist", "ul")), 
    ...
    (function() {
        ...
        function ha(a) {
            ...
            q(d, {
                ...
                place: function() {
                    ...
                    l.equals(c) ? (k.left = b.scroll.x, k.right = -b.scroll.x, k.width = "") : (k.left = j.size.left - j.size.margin.left + b.scroll.x - (a.inInlineMode ? b.editable.left + b.editable.border.left : 0), 
                    k.width = j.size.outerWidth + j.size.margin.left + j.size.margin.right + b.scroll.x, 
                    k.right = "");
                    ...
                    d.is(x) || k.top > b.scroll.y - 15 && k.top < b.scroll.y + 5 ? (k.top = a.inInlineMode ? 0 : b.scroll.y, 
                    this.look(x)) : d.is(y) || k.top > b.pane.bottom - 5 && k.top < b.pane.bottom + 15 ? (k.top = a.inInlineMode ? b.editable.height + b.editable.padding.top + b.editable.padding.bottom : b.pane.bottom - 1, 
                    this.look(y)) : (a.inInlineMode && (k.top -= b.editable.top + b.editable.border.top), 
                    this.look(s));
        ...
        function N(a, c, d) {
            ...
            n.ie && a.enterMode == CKEDITOR.ENTER_BR ? f = a.doc.createText(E) : (f = (f = K(a.element, !0)) && f.data("cke-enter-mode") || a.enterMode, 
            f = new M(F[f], a.doc), f.is("br") || a.doc.createText(E).appendTo(f));
                ...
                exec: function() {
                    ...
                    return function(b) {
                        ...
                        if (!W(a, b) && b && !b.equals(a.editable) && !b.contains(a.editable)) {
                            ...
                            e = r(a, b, !c);
                            var f;
                            m(e) && e.is(a.triggers) && e.is(ia) && (!r(a, e, !c) || (f = r(a, e, !c)) && m(f) && f.is(a.triggers)) ? d(e) : (f = J(a, b), 
                            m(f) && (r(a, f, !c) ? (b = r(a, f, !c)) && (m(b) && b.is(a.triggers)) && d(f) : d(f)));
                        }
                    };
                }()
            };
        ...
        function Y(a) {
            ...
            o(a, c);
            return !f && 0 <= c.size.top && 0 < d.y && d.y < c.size.top + e ? (a = a.inInlineMode || 0 === b.scroll.y ? x : s, 
            new u([ null, c, D, H, a ])) : f && c.size.bottom <= b.pane.height && d.y > c.size.bottom - e && d.y < b.pane.height ? (a = a.inInlineMode || c.size.bottom > b.pane.height - e && c.size.bottom < b.pane.height ? y : s, 
            new u([ c, null, Z, H, a ])) : null;
        }
        function $(a) {
            ...
            } else e.equals(a.editable[h ? "getLast" : "getFirst"](a.isRelevant)) ? (C(a), h && c.y > e.size.bottom - b && c.y < d.pane.height && e.size.bottom > d.pane.height - b && e.size.bottom < d.pane.height ? i = y : 0 < c.y && c.y < e.size.top + b && (i = x)) : i = s, 
            f = [ null, e ][h ? "reverse" : "concat"]().concat([ h ? Z : D, H, i, e.equals(a.editable[h ? "getLast" : "getFirst"](a.isRelevant)) ? h ? y : x : s ]);
        ...
        function P(a, c, d, b) {
            ...
            }(), f = c.getDocumentPosition(), i = {}, h = {}, g = {}, j = {}, l = t.length; l--; ) i[t[l]] = parseInt(e("border-" + t[l] + "-width"), 10) || 0, 
            g[t[l]] = parseInt(e("padding-" + t[l]), 10) || 0, h[t[l]] = parseInt(e("margin-" + t[l]), 10) || 0;
            (!d || b) && I(a, b);
                ...
                a.on("contentDom", function() {
                    ...
                    d.is(w.$inline) || (b.inInlineMode && !X(d) && d.setStyles({
                        ...
                        if ("wysiwyg" == a.mode) if (b.inInlineMode) {
                            ...
                            if (!(d > e.left - f.x && d < e.right - f.x) || !(c > e.top - f.y && c < e.bottom - f.y)) clearTimeout(i), 
                            i = null, b.line.detach();
                        } else clearTimeout(i), i = null, b.line.detach();
                    }), d.attachListener(d, "keyup", function() {
                        b.hiddenMode = 0;
                    }), d.attachListener(d, "keydown", function(c) {
                        if ("wysiwyg" == a.mode) switch (c = c.data.getKeystroke(), a.getSelection().getStartElement(), 
                        c) {
                          case 2228240:
                          case 16:
                        ...
                        if (!("wysiwyg" != a.mode || a.readOnly || i)) {
                            ...
                            i = setTimeout(function() {
                                ...
                                i = b.trigger = null;
                                I(b);
                                if (f && !b.hiddenMode && a.focusManager.hasFocus && !b.line.mouseNear() && (b.element = ca(b, !0))) (b.trigger = Y(b) || $(b) || da(b)) && !W(b, b.trigger.upper || b.trigger.lower) ? b.line.attach().place() : (b.trigger = null, 
                                b.line.detach()), f = !1;
                            }, 30);
                        }
                        ...
                        b.hiddenMode = 0;
                        b.mouseDown = 0;
                    }), a.addCommand("accessPreviousSpace", U(b)), a.addCommand("accessNextSpace", U(b, !0)), 
                    a.setKeystroke([ [ c.magicline_keystrokePrevious, "accessPreviousSpace" ], [ c.magicline_keystrokeNext, "accessNextSpace" ] ]), 
        ...
        var ca = function() {
            return function(a, c, d) {
                ...
                c && v(a, f) && (e.hide(), f = new CKEDITOR.dom.element(b.$.elementFromPoint(d.x, d.y)), 
                e.show());
            ...
            function a(a) {
                ...
                for (var b = Number.MAX_VALUE, h, g, j, l; f && !f.equals(e) && (g = e.getNext(a.isRelevant)); ) h = Math.abs(ga(a, e, g) - a.mouse.y), 
                h < b && (b = h, j = e, l = g), e = g, o(a, e);
    ...
    (function() {
        ...
        function q(a) {
            if (!a.editable().isInline()) {
                ...
                for (f in e) {
                    var b = e[f];
                    "wysiwyg" == b.mode && !b.readOnly && (b = b.document.getBody(), b.setAttribute("contentEditable", !1), 
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    ...
                    a.addCommand("maximize", {
                        ...
                        exec: function() {
                            ...
                            c = CKEDITOR.document.getById(c._.id), c.getChild(1).setHtml(g), c.setAttribute("title", g), 
                            c.setAttribute("href", 'javascript:void("' + g + '");');
                            "wysiwyg" == a.mode ? j ? (CKEDITOR.env.gecko && q(a), a.getSelection().selectRanges(j), 
                            (i = a.getSelection().getStartElement()) && i.scrollIntoView(!0)) : d.$.scrollTo(k.x, k.y) : (j && (i.selectionStart = j[0], 
                            i.selectionEnd = j[1]), i.scrollLeft = k[0], i.scrollTop = k[1]);
                            j = k = null;
                            l = this.state;
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("preview", {
            init: function(a) {
                a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && (h = this.path, a.addCommand("preview", i), 
    ...
    CKEDITOR.plugins.add("print", {
        init: function(a) {
            a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && (a.addCommand("print", CKEDITOR.plugins.print), 
            ...
            removeformat: {
                exec: function(a) {
                    for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), e = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), f = CKEDITOR.plugins.removeformat.filter, k = a.getSelection().getRanges(1), l = k.createIterator(), c; c = l.getNextRange(); ) {
                        ...
                        var i = c.createBookmark(), b = i.startNode, j = i.endNode, d = function(b) {
                        ...
                        if (j) {
                            ...
                            !("img" == b.getName() && b.data("cke-realelement")) && f(a, b) && (h.test(b.getName()) ? b.remove(1) : (b.removeAttributes(e), 
                            a.fire("removeFormatCleanup", b))), b = d;
                        }
                        c.moveToBookmark(i);
                    }
                    a.forceNextSelectionCheck();
        ...
        CKEDITOR.plugins.add("selectall", {
            init: function(b) {
                b.addCommand("selectAll", {
                    ...
                    exec: function(a) {
                        var b = a.editable();
                        if (b.is("textarea")) a = b.$, CKEDITOR.env.ie ? a.createTextRange().execCommand("SelectAll") : (a.selectionStart = 0, 
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("showblocks", {
            onLoad: function() {
                ...
                for (c = b = e = f = ""; d = a.pop(); ) h = a.length ? "," : "", c += ".cke_show_blocks " + d + g + h, 
                e += ".cke_show_blocks.cke_contents_ltr " + d + g + h, f += ".cke_show_blocks.cke_contents_rtl " + d + g + h, 
                b += ".cke_show_blocks " + d + g + "{background-image:url(" + i + "images/block_" + d + ".png)}";
    ...
    (function() {
        ...
        CKEDITOR.on("dialogDefinition", function(a) {
            var b = a.data.name;
            if ("table" == b || "tableProperties" == b) if (a = a.data.definition, b = a.getContents("info").get("txtBorder"), 
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        init: function(a) {
            ...
            a.contextMenu && a.addMenuItems && (a.contextMenu.addListener(function() {
                ...
                if (c) {
                    ...
                    if (h = h ? h.getAttribute(c.getNodeAttribute()) : h) b = d.menuGenerator(a, h, d), 
                    c.showBanner("." + a.contextMenu._.definition.panel.className.split(" ").join(" ."));
                }
                return b;
        ...
        addMenuItems: function(a) {
            ...
            if (b && b.length) for (var f = 0; f < b.length; f++) a.addMenuGroup("scayt_" + b[f], f - 10);
            b = {
                scaytToggle: {
            ...
            a.plugins.wsc && (b.WSC = {
                ...
                group: "scaytButton",
                onClick: function() {
                    var c = CKEDITOR.plugins.scayt, b = a.scayt, d = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.container.getText() : a.document.getBody().getText();
                    (d = d.replace(/\s/g, "")) ? (b && (c.state[a.name] && b.setMarkupPaused) && b.setMarkupPaused(!0), 
        ...
        bindEvents: function(a) {
            ...
            a.on("beforeCommandExec", function(c) {
                ...
                } else if ("bold" === c.data.name || "italic" === c.data.name || "underline" === c.data.name || "strike" === c.data.name || "subscript" === c.data.name || "superscript" === c.data.name) if (c = a.scayt) c.removeMarkupInSelectionNode(), 
            ...
            a.on("readOnly", function(c) {
                var b;
                c && (b = a.scayt, !0 === c.editor.readOnly ? b && b.fire("removeMarkupInDocument", {}) : b ? b.fire("startSpellCheck") : "wysiwyg" == c.editor.mode && !0 === d.state[c.editor.name] && (d.createScayt(a), 
            ...
            a.on("scaytDialogShown", function(c) {
        ...
        parseConfig: function(a) {
            ...
            "string" !== typeof a.config.scayt_srcUrl && (d = document.location.protocol, d = -1 != d.search(/https?:/) ? d : "http:", 
            a.config.scayt_srcUrl = d + "//svc.webspellchecker.net/spellcheck31/lf/scayt3/ckscayt/ckscayt.js");
        ...
        addRule: function(a) {
            var d = a.dataProcessor, c = d && d.htmlFilter, b = a._.elementsPath && a._.elementsPath.filters, d = d && d.dataFilter, f = a.addRemoveFormatFilter, g = function(c) {
                ...
                var b = CKEDITOR.plugins.scayt, d = !0;
            ...
            d && d.addRules({
                elements: {
                    span: function(c) {
                        var b = CKEDITOR.plugins.scayt;
                        b && (b.state[a.name] && c.classes && CKEDITOR.tools.search(c.classes, b.options.misspelled_word_class)) && (c.classes && c.parent.type === CKEDITOR.NODE_DOCUMENT_FRAGMENT ? (delete c.attributes.style, 
                        delete c.name) : delete c.classes[CKEDITOR.tools.indexOf(c.classes, b.options.misspelled_word_class)]);
                        return c;
                    }
                }
            });
            c && c.addRules({
                elements: {
                    span: function(c) {
                        var b = CKEDITOR.plugins.scayt;
                        b && (b.state[a.name] && c.hasClass(b.options.misspelled_word_class) && c.attributes[b.options.data_attribute_name]) && (c.removeClass(b.options.misspelled_word_class), 
                        delete c.attributes[b.options.data_attribute_name], delete c.name);
                        return c;
                    }
                }
            });
        ...
        menuGenerator: function(a, d) {
            ...
            for (var e in b) -1 == CKEDITOR.tools.indexOf(g, e.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (f[e] = CKEDITOR.TRISTATE_OFF, 
            "function" === typeof b[e].verification && !b[e].verification(a) && delete f[e], 
            a.addCommand(e, {
                exec: b[e].exec
            }), a.addMenuItem(e, {
    ...
    CKEDITOR.plugins.scayt = {
        ...
        replaceOldOptionsNames: function(a) {
            for (var d in a) d in this.backCompatibilityMap && (a[this.backCompatibilityMap[d]] = a[d], 
            delete a[d]);
        },
        ...
        loadScaytLibrary: function(a, d) {
            var c = this;
            "undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? (this.loadingHelper[a.name] = d, 
            this.loadingHelper.loadOrder.push(a.name), CKEDITOR.scriptLoader.load(a.config.scayt_srcUrl, function() {
                var a;
        ...
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            ...
            a[d] = CKEDITOR.tools.override(a[d], function(a) {
                return function(b) {
                    ...
                    CKEDITOR.plugins.scayt && (CKEDITOR.plugins.scayt.state[b.editor.name] && b.editor.scayt) && (this.contents = d.removeMarkupFromString(g) || "", 
                    b.contents = d.removeMarkupFromString(e) || "");
        ...
        CKEDITOR.plugins.add("stylescombo", {
            ...
            init: function(c) {
                ...
                c.on("stylesSet", function(b) {
                    if (b = b.data.styles) {
                        for (var a, h, d, e = 0, l = b.length; e < l; e++) if (a = b[e], !(c.blockless && a.element in CKEDITOR.dtd.$block) && (h = a.name, 
                        a = new CKEDITOR.style(a), !c.filter.customConfig || c.filter.check(a))) a._name = h, 
                        a._.enterMode = j.enterMode, a._.type = d = a.assignedTo || a.type, a._.weight = e + 1e3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3), 
                ...
                c.ui.addRichCombo("Styles", {
                    ...
                    init: function() {
                        var b, a, c, d, e, f;
                        e = 0;
                        for (f = i.length; e < f; e++) b = i[e], a = b._name, d = b._.type, d != c && (this.startGroup(g["panelTitle" + d]), 
    ...
    (function() {
        function p(e) {
            function d(a) {
                !(0 < b.length) && (a.type == CKEDITOR.NODE_ELEMENT && y.test(a.getName()) && !a.getCustomData("selected_cell")) && (CKEDITOR.dom.element.setMarker(c, a, "selected_cell", !0), 
                b.push(a));
            }
        ...
        function o(e, d) {
            for (var b = p(e), c = b[0], a = c.getAscendant("table"), c = c.getDocument(), f = b[0].getParent(), g = f.$.rowIndex, b = b[b.length - 1], h = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(a.$.rows[h]), g = d ? g : h, f = d ? f : b, b = CKEDITOR.tools.buildTableMap(a), a = b[g], g = d ? b[g - 1] : b[g + 1], b = b[0].length, c = c.createElement("tr"), h = 0; a[h] && h < b; h++) {
                var i;
                1 < a[h].rowSpan && g && a[h] == g[h] ? (i = a[h], i.rowSpan += 1) : (i = new CKEDITOR.dom.element(a[h]).clone(), 
                i.removeAttribute("rowSpan"), i.appendBogus(), c.append(i), i = i.$);
                h += i.colSpan - 1;
            }
        ...
        function k(e, d) {
            ...
            a.removeAttribute("colSpan"), a.appendBogus(), a[d ? "insertBefore" : "insertAfter"].call(a, new CKEDITOR.dom.element(c[h])), 
            a = a.$), h += a.rowSpan - 1);
        }
        function u(e, d) {
        ...
        function s(e, d, b) {
            ...
            c = b.count();
            for (d = c - 1; 0 <= d; d--) a = b.getItem(d), a.$.cells.length || (a.remove(), 
            c++);
            return e;
        }
        function w(e, d) {
            ...
            if (1 < i) {
                j = Math.ceil(i / 2);
                for (var i = Math.floor(i / 2), c = g + j, a = new CKEDITOR.dom.element(a.$.rows[c]), f = v(f, c), l, c = b.clone(), g = 0; g < f.length; g++) if (l = f[g], 
                l.parentNode == a.$ && g > h) {
        ...
        CKEDITOR.plugins.tabletools = {
            ...
            init: function(e) {
                ...
                b("columnDelete", d({
                    requiredContent: "table",
                    exec: function(a) {
                        for (var a = a.getSelection(), a = p(a), b = a[0], c = a[a.length - 1], a = b.getAscendant("table"), d = CKEDITOR.tools.buildTableMap(a), e, j, l = [], n = 0, o = d.length; n < o; n++) for (var k = 0, q = d[n].length; k < q; k++) d[n][k] == b.$ && (e = k), 
                        d[n][k] == c.$ && (j = k);
                        for (n = e; n <= j; n++) for (k = 0; k < d.length; k++) c = d[k], b = new CKEDITOR.dom.element(a.$.rows[k]), 
                        c = new CKEDITOR.dom.element(c[n]), c.$ && (1 == c.$.colSpan ? c.remove() : c.$.colSpan -= 1, 
                        k += c.$.rowSpan - 1, b.$.cells.length || l.push(b));
    ...
    (function() {
        ...
        f.prototype = {
            equalsContent: function(a) {
                ...
                if (CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks)) c = c.replace(i, ""), 
                a = a.replace(i, "");
                return c != a ? !1 : !0;
            },
        ...
        g.prototype = {
            type: function(a, c) {
                ...
                if (!this.typing || c && !this.wasCharacter || d) {
                    ...
                    CKEDITOR.tools.setTimeout(function() {
                        ...
                        e.contents != a && g == this.snapshots.length && (this.typing = !0, this.save(!1, e, !1) || this.snapshots.splice(this.index + 1, this.snapshots.length - this.index - 1), 
                        this.hasUndo = !0, this.hasRedo = !1, this.modifiersCount = this.typesCount = 1, 
                        this.onChange());
                    }, 0, this);
                }
                this.lastKeystroke = a;
                (this.wasCharacter = c) ? (this.modifiersCount = 0, this.typesCount++, 25 < this.typesCount ? (this.save(!1, null, !1), 
                this.typesCount = 1) : setTimeout(function() {
                    b.fire("change");
            ...
            restoreImage: function(a) {
                ...
                a.bookmarks ? d.selectBookmarks(a.bookmarks) : CKEDITOR.env.ie && (d = this.editor.document.getBody().$.createTextRange(), 
                d.collapse(!0), d.select());
                this.locked = 0;
                this.index = a.index;
