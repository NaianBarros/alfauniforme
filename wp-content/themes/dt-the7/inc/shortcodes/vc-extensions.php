...
if (class_exists('WPBakeryVisualComposerAbstract')) {
	...
	/**
	 * Return dt_title VC shortcode param HTML.
	 *
	 * @param $settings
	 * @param $value
	 *
	 * @return string
	 */
	function presscore_vc_title_settings_field( $settings, $value ) {
		$html = '';
		return $html;
	}
	...
	function presscore_vc_add_custom_fields() {
		...
		vc_add_shortcode_param( 'dt_title', 'presscore_vc_title_settings_field' );
	}
